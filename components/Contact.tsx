                ...
                <div>
                  ...
                  <div className="flex items-center gap-3">
                    ...
                    <a 
                      ...
                      className="relative inline-flex items-center justify-center rounded-full text-white transition-all hover:scale-110 shadow-lg group"
                      title="Chat en WhatsApp"
                    >
                      {/* Onda expansiva (Timbre) */}
                      <span className="absolute inset-0 rounded-full bg-[#25D366] opacity-75 animate-ping"></span>
                      
                      {/* Botón visible */}
                      <span className="relative p-2 bg-[#25D366] rounded-full hover:bg-[#128C7E] transition-colors">
